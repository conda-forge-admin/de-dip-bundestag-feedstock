...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/de-dip-bundestag-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/de-dip-bundestag-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add de-dip-bundestag
# for installing globally
pixi global install de-dip-bundestag
```
...
It is possible to list all of the versions of `de-dip-bundestag` available on your platform:
...
```
pixi search de-dip-bundestag --channel conda-forge
```
